...
chcp 65001 >nul
title KAS Skills Installer for Hermes v120726

echo.
echo ============================================
echo   KAS Hermes Skills Installer v12.07.26
...
hermes send --platform telegram --to 8702982867 "🔔 %USERNAME%@%COMPUTERNAME% ติดตั้ง KAS Skills v120726 แล้ว !COUNT! skills — /reload-skills" 2>nul
if errorlevel 1 (
